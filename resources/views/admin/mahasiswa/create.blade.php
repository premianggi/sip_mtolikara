...
<form role="form" class="form-horizontal" action="{{route('mahasiswa.store')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
        <input type="text" name="nama_mahasiswa" class="form-control" required oninvalid="this.setCustomValidity('data nama mahasiswa tidak boleh kosong')" oninput="setCustomValidity('')">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" for="nama universitas">Tempat Lahir</label>
        <div class="col-sm-5">
        <input type="text" name="tempat_lahir" class="form-control" required oninvalid="this.setCustomValidity('data tempat lahir tidak boleh kosong')" oninput="setCustomValidity('')">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" for="nama universitas">Tanggal Lahir</label>
        <div class="col-sm-3">
        <input type="date" name="tanggal_lahir" class="form-control" required oninvalid="this.setCustomValidity('data tanggal lahir tidak boleh kosong')" oninput="setCustomValidity('')">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="nama universitas">Nomor Telepon</label>
        <div class="col-sm-4">
